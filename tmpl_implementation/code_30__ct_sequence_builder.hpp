...
/// Building sequence from 4 values.
...
/// Building sequence from 5 values.
...
{
    // static_assert(false, "Error on general sequence_6");
};

template <int V1, int... Values>
struct ct_sequence_6< V1, Values... >
{
    typedef ct_sequence<
        V1, typename ct_sequence_6<Values...>::type> type;
};
